var YoutubeDelayed = {
  initPlayer: function(node) {
    ...
    node.style.backgroundImage = node.getAttribute('data-image')
      ? 'url(' + image + ')'
      : 'url(https://img.youtube.com/vi/' + videoId + '/' + image + ')';
    node.innerHTML =
      '<a class="play-button" href="https://www.youtube.com/watch?v=' +
      videoId +
      '" target="_blank"><span class="play-button_icon"><svg viewBox="0 0 15 18" xmlns="https://www.w3.org/2000/svg"><polygon points="0 0 0 18 15 9 0 0"></polygon></svg></span></a>' +
