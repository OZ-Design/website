var YoutubeDelayed = {
  initPlayer: function(node) {
    ...
    node.innerHTML =
      ...
      videoId +
      '" target="_blank"><span class="play-button_side play-button_icon"><svg viewBox="0 0 15 18" xmlns="http://www.w3.org/2000/svg"><polygon points="0 0 0 18 15 9 0 0"></polygon></svg></span><span class="play-button_side play-button_text"><span>Play<br>video</span></span></a>' +
